        ...
        <div class="card_center" id="card2">
          <div class="row">
            ...
            <div class="col-md-9 group1">
              <div class="row">
                <div class="col-md-4"><span>姓名: <input type="text" style="width: 7em; height: 2em;"></span></div>
                <div class="col-md-5"><span>電話號碼: <input type="text" style="width: 9em; height: 2em;"></span></div>
                <div class="col-md-3"><span>性別: 男</span></div>
              </div>
              <div class="row">
                <div class="col-md-4"><span>生日: <input type="date" style="width: 7em; height: 2em;"></span></div>
                <div class="col-md-5"><span>電子信箱: </span></div>
