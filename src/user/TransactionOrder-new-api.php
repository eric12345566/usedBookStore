<?php
  ...
  if($book[0]['username'] == $username){
    echo "<script type='text/javascript'>alert('不可以買自己的書喔！'); window.location.href='Book_information.php?product_no=". $pid . "';</script>";
    // document.location.href='Book_information.php?product_no='".$pid.";
