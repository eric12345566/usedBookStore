              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="modal fade" id="order_info" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                      <div class="modal-content">
                        <form action="./API/order/order-update.php" method="post">
                          <div class="modal-header">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              <label>買家帳號</label>
                              <input type="text" name="p_username" class="form-control" id="p_username" disabled>
                            </div>
                            <div class="form-group">
                              <label>賣家帳號</label>
                              <input type="text" name="s_username" class="form-control" id="s_username" aria-describedby="emailHelp" disabled>
                            </div>
                            <div class="form-group">
                              <label>書本商品編號</label>
                              <input type="text" name="product_no" class="form-control" id="product_no" disabled>
                            </div>
                            <div class="form-group">
                              <label>商品數量</label>
                            ...
                            <div class="form-group">
                              <label>取消訂單原因</label>
                              <textarea class="form-control" id="cancel_reason" name="cancel_reason" rows="4" disabled></textarea>
                            </div>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
